          ...
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              ...
              <form action="" method="POST">
                                ...
                                <input type="text" name="id_agama" id="id_agama" class="form-control " value="<?= $edit['id_agama']; ?>">   
                                    </div>
                                    <div class="form-outline mb-3 col-12">
                                    <label class="mx-2" for="nm">Nama Agama</label>
                                    <input type="text" name="nama_agama" class="form-control" id="nm" value="<?= $edit['nama_agama'] ?>">    
                                    </div>
